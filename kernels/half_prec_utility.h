...
EXTERNC void downcast_block(const void* src_block, int width, int height, int ld, void* dest_block);
EXTERNC void upcast_block( void* src_block, int width, int height, int ld, void* dest_block);
